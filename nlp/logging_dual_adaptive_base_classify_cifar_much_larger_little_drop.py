...
results_folder = '/media/chad/nara/meta/cifar/results/'+str(sys.argv[0])+ sys.argv[1] + sys.argv[2] + str(datetime.datetime.now())+'/'
...
final_results_file_name = '/media/chad/nara/meta/cifar/results/final_best_results_much_larger_little_drop_vgg16_output_only.txt'
accuracies_file = open(accuracies_file_name, "w+")
accuracies_file.close()

configure(results_folder+sys.argv[0]+'tblogfile')

#single_layer_correct_train_file = '/media/chad/paro/vgg11_bn/train/conv_22_layer/correct_sorted_outputs.torch'
#single_layer_incorrect_train_file = '/media/chad/paro/vgg11_bn/train/conv_22_layer/incorrect_sorted_outputs.torch'

#single_layer_correct_valid_file = '/media/chad/paro/vgg11_bn/valid/conv_22_layer/correct_sorted_outputs.torch'
#single_layer_incorrect_valid_file = '/media/chad/paro/vgg11_bn/valid/conv_22_layer/incorrect_sorted_outputs.torch'

single_layer_correct_train_file = '/media/chad/paro/' + sys.argv[2] + '/train/' + sys.argv[1] + '/correct_sorted_outputs.torch'
single_layer_incorrect_train_file = '/media/chad/paro/' + sys.argv[2] + '/train/' + sys.argv[1] + '/incorrect_sorted_outputs.torch'

single_layer_correct_valid_file = '/media/chad/paro/' + sys.argv[2] + '/valid/' + sys.argv[1] + '/correct_sorted_outputs.torch'
single_layer_incorrect_valid_file = '/media/chad/paro/' + sys.argv[2] + '/valid/' + sys.argv[1] + '/incorrect_sorted_outputs.torch'
