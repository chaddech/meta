...
full_train_idx = np.load('MNIST_50000_train_indices.npy')
full_valid_idx = np.load('MNIST_10000_valid_indices.npy')
...
def main():
    ...
    parser.add_argument('--base_train_num_epochs', type=int, default=1, metavar='basetrainepochs',
                        help='size of batches to the meta classifier')
    parser.add_argument('--meta_train_num_epochs', type=int, default=100, metavar='metatrainepochs',
                        help='size of batches to the meta classifier')
    ...
    for x in [1,5,10,15,20,25,30,35,40,45,50]:
        ...
        meta_train_sampler = SubsetRandomSampler(full_train_idx)

        meta_validation_sampler = SubsetRandomSampler(full_valid_idx)
        ...
        for l in ['fc1', 'output', 'conv1', 'conv2']:
            correct, error, test_correct, test_error = make_and_train_meta_model(args, device, train_set_percentage=1, layer=l)
