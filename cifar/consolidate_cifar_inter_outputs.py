...
torch.save(valid_correct_tensors, '/media/chad/nara/cifar/wide/valid/'+inter_layer+'/correct_outputs.torch')
torch.save(valid_error_tensors, '/media/chad/nara/cifar/wide/valid/'+inter_layer+'/incorrect_outputs.torch')
...
torch.save(train_correct_tensors, '/media/chad/nara/cifar/wide/train/'+inter_layer+'/correct_outputs.torch')
torch.save(train_error_tensors, '/media/chad/nara/cifar/wide/train/'+inter_layer+'/incorrect_outputs.torch')
