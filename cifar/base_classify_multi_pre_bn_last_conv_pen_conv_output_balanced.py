...
# results_folder = os.getcwd() + '/results/'+ str(sys.argv[0])+str(datetime.datetime.now().timestamp())+'/'
filename = 'base_classify_multi_pre_bn_last_conv_pen_conv_output_balanced.py'
results_folder = os.getcwd() + '/results/' + filename + '/' + str(datetime.datetime.now().timestamp()) + '/'
os.makedirs(results_folder)
copyfile(filename, results_folder + filename)
accuracies_file_name = results_folder + filename + '_accuracies_record.txt'
accuracies_file = open(accuracies_file_name, "w+")
accuracies_file.close()

outputs_correct_train_file = os.getcwd() + '/wide/train/output/correct_outputs.torch'
outputs_error_train_file = os.getcwd() + '/wide/train/output/incorrect_outputs.torch'

outputs_correct_valid_file = os.getcwd() + '/wide/valid/output/correct_outputs.torch'
outputs_error_valid_file = os.getcwd() + '/wide/valid/output/incorrect_outputs.torch'

pre_bn_layer_correct_train_file = os.getcwd() + '/wide/train/pre_bn_layer/correct_outputs.torch'
pre_bn_layer_error_train_file = os.getcwd() + '/wide/train/pre_bn_layer/incorrect_outputs.torch'

pre_bn_layer_correct_valid_file = os.getcwd() + '/wide/valid/pre_bn_layer/correct_outputs.torch'
pre_bn_layer_error_valid_file = os.getcwd() + '/wide/valid/pre_bn_layer/incorrect_outputs.torch'

last_conv_correct_train_file = os.getcwd() + '/wide/train/post_last_conv_layer/correct_outputs.torch'
last_conv_error_train_file = os.getcwd() + '/wide/train/post_last_conv_layer/incorrect_outputs.torch'

last_conv_correct_valid_file = os.getcwd() + '/wide/valid/post_last_conv_layer/correct_outputs.torch'
last_conv_error_valid_file = os.getcwd() + '/wide/valid/post_last_conv_layer/incorrect_outputs.torch'

pen_conv_correct_train_file = os.getcwd() + '/wide/train/post_penultimate_conv_layer/correct_outputs.torch'
pen_conv_error_train_file = os.getcwd() + '/wide/train/post_penultimate_conv_layer/incorrect_outputs.torch'

pen_conv_correct_valid_file = os.getcwd() + '/wide/valid/post_penultimate_conv_layer/correct_outputs.torch'
pen_conv_error_valid_file = os.getcwd() + '/wide/valid/post_penultimate_conv_layer/incorrect_outputs.torch'
...
def main():
    ...
    train_error_files = (
        outputs_error_train_file, pre_bn_layer_error_train_file, last_conv_error_train_file, pen_conv_error_train_file)
    train_correct_files = (outputs_correct_train_file, pre_bn_layer_correct_train_file, last_conv_correct_train_file,
                           pen_conv_correct_train_file)

    valid_correct_files = (outputs_correct_valid_file, pre_bn_layer_correct_valid_file, last_conv_correct_valid_file,
                           pen_conv_correct_valid_file)
    valid_error_files = (
        outputs_error_valid_file, pre_bn_layer_error_valid_file, last_conv_error_valid_file, pen_conv_error_valid_file)
    ...
    print("\nCORRECT")
    valid_correct_dataset = ImageNetInterMediateLayersInMemoryDataset(empty_files, valid_correct_files,
                                                                      one_class='correct')
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        correct_acc, error_acc = test(model, device, error_validation_loader, correct_validation_loader, optimizer,
                                      epoch)
        ...
        accuracies_file.write(
            str(epoch) + " " + str(train_acc) + " " + " " + str(correct_acc) + " " + str(error_acc) + " " + str(
                total_geo_acc) + " " + str(total_diff_adj_geo_acc) + "\n")
        accuracies_file.close()
        ...
        if total_diff_adj_geo_acc > best_total_diff_adj_geo_acc:
            ...
            old_diff_adj_geo_acc_file_name = results_folder + '_best_diff_adj_geo_acc_valid_epoch_' + str(
                epoch) + '.pth'
